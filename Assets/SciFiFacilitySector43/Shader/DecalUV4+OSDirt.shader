...
Shader "Triplebrick/DecalDirt_OS"
{
	Properties
	{
	...
	SubShader
	{
		...
		uniform sampler2D _DetailMaskRAOA;
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float4 triplanar1 = TriplanarSamplingSF( _DirtRTintGSmoothnessA, ase_vertex3Pos, ase_vertexNormal, 1.0, appendResult13, 1.0, 0 );
			float4 lerpResult15 = lerp( _MainColor , _TintColor , triplanar1.y);
			float2 uv_DetailMaskRAOA20 = i.uv_texcoord;
			float4 tex2DNode20 = tex2D( _DetailMaskRAOA, uv_DetailMaskRAOA20 );
